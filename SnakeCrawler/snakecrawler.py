...
small_font = pygame.font.SysFont("Minecraft.ttf" , 25)
large_font = pygame.font.SysFont("Minecraft.ttf" , 28)

class Shop():
    def __init__(self):
        #Importing images of shop and their item images
        shop_background1 = pygame.image.load("sprite\shop_background.png").convert_alpha()
        shop_background2 = pygame.image.load("sprite\shop_background2.png").convert_alpha()
...
class Background():
    def __init__(self):
        self.background = pygame.image.load("sprite\sky.png").convert_alpha()
...
class Button():
    def __init__(self, x, y, type):
        start_image1 = pygame.image.load("sprite\start_button.png").convert_alpha()
        start_image2 = pygame.image.load("sprite\start_button_hover.png").convert_alpha()

        shop_image1 = pygame.image.load("sprite\shop_button.png").convert_alpha()
        shop_image2 = pygame.image.load("sprite\shop_button_hover.png").convert_alpha()

        retry_image1 = pygame.image.load("sprite\etry_button.png").convert_alpha()
        retry_image2 = pygame.image.load("sprite\etry_button_hover.png").convert_alpha()

        back_image1 = pygame.image.load("sprite\ck_button.png").convert_alpha()
        back_image2 = pygame.image.load("sprite\ck_button_hover.png").convert_alpha()

        shop_background2_icon = pygame.image.load("sprite\shop_background2_icon.png").convert_alpha()
        extra_life_icon = pygame.image.load("sprite\life.png").convert_alpha()
        item2 = pygame.image.load("sprite\item1.png").convert_alpha()
        item2 = pygame.image.load("sprite\item1.png").convert_alpha()
        
        soldout = pygame.image.load("sprite\soldout.png").convert_alpha()
...
class Player():
    def __init__(self,x,y):
        ...
        player1 = pygame.image.load("sprite\snakeleft1.png").convert_alpha()
        player1 = pygame.transform.scale(player1,(40,20))
        player2 = pygame.image.load("sprite\snakeleft2.png").convert_alpha()
...
class Platform(pygame.sprite.Sprite):
    def __init__(self, x, y, width, movement):
        ...
        platform_image = pygame.image.load("sprite\platform.png").convert_alpha()
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, screen_width, y, speed):
        ...
        enemy = pygame.image.load("sprite\enemy.png").convert_alpha()
